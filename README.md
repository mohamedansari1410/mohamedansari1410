...
const mohamedAnsari = {
  ...
  role:     "Trainee Software Engineer @ Rudhra Ingenious Solutions",
  degree:   "BCA – Computer Application (CGPA 8.0 / 10.0)",

  stack: [
    "Salesforce (Apex, LWC, Flows, SOQL, SOSL)",
    "MuleSoft (Anypoint Platform, CloudHub)",
    "Agentforce",  "Experience Cloud",
    "FHIR / ABDM", "REST APIs",
  ...
  motto: () => "Automate the boring stuff. Architect the great stuff.",
};
```
...
<details>
<summary><strong>🏥 Rudhra Ingenious Solutions (RIS)</strong> &nbsp;—&nbsp; Trainee Software Engineer &nbsp;|&nbsp; Jan 2026 – Present &nbsp;|&nbsp; Chennai, India</summary>

<br/>

> ![Salesforce](https://img.shields.io/badge/Salesforce-00A1E0?style=flat-square&logo=salesforce&logoColor=white) ![LWC](https://img.shields.io/badge/LWC-0176D3?style=flat-square&logo=salesforce&logoColor=white) ![Apex](https://img.shields.io/badge/Apex-1798C1?style=flat-square&logo=salesforce&logoColor=white) ![MuleSoft](https://img.shields.io/badge/MuleSoft-005F8B?style=flat-square&logo=mulesoft&logoColor=white) ![Agentforce](https://img.shields.io/badge/Agentforce-00A1E0?style=flat-square&logo=salesforce&logoColor=white) ![Experience Cloud](https://img.shields.io/badge/Experience%20Cloud-0176D3?style=flat-square&logo=salesforce&logoColor=white) ![Jira](https://img.shields.io/badge/Jira-0052CC?style=flat-square&logo=jira&logoColor=white)

- 🏗️ Developed end-to-end **LWC components and Apex backend** for **Meditity**, a Sales Cloud–based healthcare POC, handling both UI and server-side logic across multiple modules.
- 💬 Integrated the **WhatsApp SMS 360** app package into the Salesforce org and configured **Experience Cloud** for external patient-facing portals with custom LWC UIs.
- 🤖 Built **Agentforce** employee and service agents with custom Flows and actions, enabling intelligent automated responses for internal and customer-facing use cases.
- 🔄 Collaborated in cross-functional sprints using **Jira** for task tracking and **Git/GitHub** for version control and code reviews.

</details>

<details>
<summary><strong>☁️ Cloud Champ Technologies (A subsidiary of RIS)</strong> &nbsp;—&nbsp; Salesforce Developer Trainee &nbsp;|&nbsp; Jun 2025 – Dec 2025 &nbsp;|&nbsp; Chennai, India</summary>

<br/>

> ![Salesforce](https://img.shields.io/badge/Salesforce-00A1E0?style=flat-square&logo=salesforce&logoColor=white) ![Apex](https://img.shields.io/badge/Apex-1798C1?style=flat-square&logo=salesforce&logoColor=white) ![Flows](https://img.shields.io/badge/Flows-0176D3?style=flat-square&logo=salesforce&logoColor=white) ![SOQL](https://img.shields.io/badge/SOQL-1798C1?style=flat-square&logo=salesforce&logoColor=white) ![SOSL](https://img.shields.io/badge/SOSL-1798C1?style=flat-square&logo=salesforce&logoColor=white)

- 📚 Gained structured, hands-on training in **Salesforce Administration, Apex, Triggers, Flows, SOQL, SOSL**, and Test Classes through a focused developer curriculum.
- ⚙️ Worked on real-time **business process automation** scenarios to strengthen CRM concepts, object relationships, and data management practices.
- 🚀 Built foundational knowledge in declarative and programmatic Salesforce development that directly transitioned into production project work at RIS.
...
|:-------|:------------|:----:|:-----:|
| BCA — Computer Application | Peri College of Arts & Science | Jun 2023 | CGPA 8.0 / 10.0 |
| Higher Secondary (12th) | ST. Thomas Matric. Hr. Sec. School | May 2020 | 73% |
...
```
🏆 Salesforce Platform Developer I   →  Apex, Governor Limits, Unit Testing, Async Apex
🔗 MuleSoft Certified Developer L1   →  DataWeave 2.0, Error Handling, API Policies
🤖 Advanced Agentforce               →  Custom Agents, Prompt Templates, AI Actions
⚕️  FHIR R4 & HL7                   →  Resource Mapping, ABDM Compliance, Clinical APIs
🛡️  Copado DevOps                   →  CI/CD Pipelines, User Story Automation, Compliance
```
